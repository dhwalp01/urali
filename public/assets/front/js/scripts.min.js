  ...
  (function () {
    ...
    (function (toggleSel, menuSel, backdropSel) {
      const $toggle = $(toggleSel),
        $menu = $(menuSel),
        $backdrop = $(backdropSel);

      function openMenu() {
        $backdrop.addClass("active");
        $toggle.addClass("active");
        $menu
          // add animate__faster for a 0.5s animation
          .addClass(
            "open animate__animated animate__slideInLeft animate__faster"
          )
          .one("animationend", () => {
            $menu.removeClass(
      ...
      function closeMenu() {
        ...
        $menu
          ...
          .addClass("animate__animated animate__slideOutLeft animate__faster")
          .one("animationend", () => {
            $menu.removeClass(
              "animate__animated animate__slideOutLeft animate__faster open"
            );
          });
      }
