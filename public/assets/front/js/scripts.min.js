  ...
  (function () {
    ...
    (function (b, c) {
      ...
      a(b).on("click", function (e) {
        ...
        a(this).find("i").toggleClass("");

        var $mobileMenu = a(c);

        // If menu is not open, add opening animation with slideInLeft
        if (!$mobileMenu.hasClass("open")) {
          $mobileMenu
            .removeClass("animate__slideOutRight")
            .addClass("open animate__animated animate__slideInLeft");
        } else {
          // If menu is open, add closing animation with slideOutRight
          $mobileMenu
      ...
      a(document).on("click", function (e) {
        var $mobileMenu = a(c);
        var $mobileMenuToggle = a(b);

        if (
          !a(e.target).closest(c).length &&
          !a(e.target).closest(b).length &&
