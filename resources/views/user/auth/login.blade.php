    ...
    <div class="row justify-content-center py-4">
            <div class="col-md-6">
              <form class="card auth-form-card" method="post" action="{{route('user.login.submit')}}">
                  @csrf
                <div class="card-body ">
                  <h4 class="margin-bottom-1x text-center">{{__('Sign in')}}</h4>
                  ...
                  <div class="d-flex flex-wrap justify-content-between padding-bottom-1x">
                    <a class="text-base-color" href="{{ route("user.register") }}">{{ __('Create Account') }}</a>
                  ...
                  <div class="text-center">
                    <button class="btn btn-primary margin-bottom-none" type="submit"><span>{{ __('Sign in') }}</span></button>
                  </div>
                  <div class="row">
